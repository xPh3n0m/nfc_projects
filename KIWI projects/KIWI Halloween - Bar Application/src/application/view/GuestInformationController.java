...
public class GuestInformationController {
    ...
    @FXML
    private Button unregisterGuestButton;
    ...
    public void unregisterGuest() {
    	...
    	currentGuest.setStatus("Inactive");
    	
    	UnregisterGuest unregisterGuest = new UnregisterGuest(currentGuest, nfcComm, currentCard, connDB);
    	...
    	unregisterGuest.setOnSucceeded(
    			new EventHandler<WorkerStateEvent>() {
				    ...
				    public void handle(WorkerStateEvent t) {
				    	messageLabel.setText("Succesfully unregistered guest");
				    	currentGuest = null;
				    	currentCard = null;
    ...
    public void registerGuest() {
    	...
    	if(update) {
    		...
    		Guest g = Guest.newGuestForUpdate(new Integer(guestIdTextField.getText()), 
    				guestNameTextField.getText(), new Double(guestBalanceTextField.getText()), currentCard, connDB);
    ...
    public void getCashBack() {
    	double amount = new Double (guestBalanceTextField.getText());
    	Order o = Order.createOrder(0, 1, amount);
    	List<Order> orderList = new ArrayList<Order>();
    	orderList.add(o);
    	newTransaction(orderList);
    ...
    public void newTransaction(List<Order> orderList) {
    	...
    	ProcessTransaction processTransaction = new ProcessTransaction(nfcComm, currentCard, connDB, currentGuest, orderList);
    	...
    	processTransaction.setOnSucceeded(
    			new EventHandler<WorkerStateEvent>() {
        		    ...
        		    public void handle(WorkerStateEvent t) {
        		    	...
        		    	guestBalanceTextField.setText(transaction.getGuest().getBalance() + "");
        		    	messageLabel.setText("Succesfully processed transaction " + transaction.getTransactionId());
    ...
    public void updateTotal() {
    	...
    	int nbWhiteWine = new Integer(whiteWineTextField.getText());
    	int nbSpirits = new Integer(spiritsTextField.getText());
    	totalTextField.setText((nbBeers * 5.0 + nbRedWine * 8.0 + nbWhiteWine * 8.0 + nbSpirits * 10.0) + "");
    }
	...
	public void transactionExample() {
    	...
    	Order o = Order.createOrder(itemId, numItem, itemPrice);
    	
    	int itemId2 = 3;
    	int numItem2 = 2;
    	double itemPrice2 = 7.0;
    	
    	Order o1 = Order.createOrder(itemId2, numItem2, itemPrice2);
